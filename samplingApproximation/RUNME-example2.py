...
from   models  import newton_sysid2015_example2
...
# Setup the model
##############################################################################
sys              = newton_sysid2015_example2.ssm()
...
sys.generateData(np.zeros(sys.T),'../data/example2_T1000/data'+str(iDataSet+1)+'.txt',"xy");
...
th               = newton_sysid2015_example2.ssm()
th.nParInference = 2;
th.copyData(sys);
